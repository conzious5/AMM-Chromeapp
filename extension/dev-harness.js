...
globalThis.chrome = {
  ...
  runtime: { async sendMessage(message) {
    if (message.type === "GET_CONFIG" || message.type === "SIGN_IN") return { ok: true, result: { authenticatedUser: "developer@amm-voice.local", senderAddresses: ["hello@authentic-moments.com", "cylina@authentic-moments.com"] } };
